...
- [Rimsenal AVP](https://steamcommunity.com/sharedfiles/filedetails/?id=849231601)
  - Switch AVP battle rifle to .277 Fury (done)
  - Look at removing or changing carbine
  - remove compound bow, marksman rifle, AM Rifle (done)
  - examine charge weapon changes
- Biotech
  - Scyther changed to 1 bandwidth
- VE Weapons
  - change sounds for battle rifle (done)
- Cold Tactical Style conflicts (done)
- Military Surplus Style conflicts (done)
